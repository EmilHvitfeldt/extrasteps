...
`step_date_nearest()` creates a *specification* of a recipe step that
will create new columns indicating the time to nearest recurrent event.
...
![](figures/date_nearest-1.png)![](figures/date_nearest-2.png)![](figures/date_nearest-3.png)![](figures/date_nearest-4.png)
...
#> # A tibble: 5,698 × 3
#>    ridership date_nearest_easter date_nearest_weekend
#>        <dbl>               <int>                <int>
#>  1     15.7                   83                    1
#>  2     15.8                   82                    2
#>  3     15.9                   81                    3
