...
#'
#' `step_date_nearest` creates a *specification* of a recipe
#'  step that will create new columns indicating the time to nearest
#'  recurrent event.
#'
...
bake.step_date_nearest <- function(object, new_data, ...) {
  ...
  new_cols <- purrr::imap_dfc(object$columns, date_nearest_helper,
